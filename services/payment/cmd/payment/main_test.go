...
// for the payment binary. /readyz must be reachable in disabled
// mode and must return 200 because no dependencies are wired.
// Before the fix the endpoint did not exist at all and a /readyz
// probe would 404.
